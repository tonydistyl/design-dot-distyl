...
// AccordionTrigger, AccordionContent) on Radix. The bare border-b and the chevron's
// muted-foreground are mapped to Cognition tokens (border-default / text-subtle),
// so it themes via [data-theme="dark"] with no dark: classes. Expand/collapse uses
// the animate-accordion-* utilities defined in globals.css.
