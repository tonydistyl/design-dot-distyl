...
const parts = [
  ...
  {
    name: "ChartConfig",
    desc: "Per-series label, optional icon, and color. Use a Cognition token var for color (e.g. var(--color-background-primary)).",
  },
  {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-border-danger bg-background-danger p-5">
            ...
            <p className="text-small text-text-default">
              ...
              drive them from the config with token vars so they theme. And
              don&apos;t stack more than a few series; past three or four, bars
              get hard to read.
            </p>
          </div>
